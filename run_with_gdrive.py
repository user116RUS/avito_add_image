...
def run_with_gdrive():
    """Запуск обработки XML и создание Excel на Google Drive (без обработки изображений)"""
    print(f"Начало обработки и выгрузки на Google Drive: {datetime.now()}")
    ...
    # Загружаем XML-файл
    if download_xml():
        # Обрабатываем XML и создаем Excel
